...
namespace MyAudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        public static string[] filelist = new string[] { "Asathoma.mp3", "AshtotharaSathaNama.mp3", "AumTatSat.mp3","bhajanbinasukha.mp3", "brahmapanam.mp3", 
                                                   "chandaKiran.mp3", "madhavamurahara.mp3", "manasebhajare.mp3", "Mangalaarthi.mp3", "Suprabatham.mp3" };
        ...
        static AudioPlayer()
        {
         ...
         /*   AudioTrack audioTrack = null;
            ...
            audioTrack = new AudioTrack(new Uri("Ek_Omkar.wma", UriKind.Relative),
                                "Ek_Omkar_App",
                                "PhoneApp",
                                "",
                                null);
        ...
        private static void LoadfromStorage()
        {
            ...
            try
            {
                using (IsolatedStorageFile storage = IsolatedStorageFile.GetUserStoreForApplication())
                {
                    ...
                    lock (storage)
                    {
                        using (IsolatedStorageFileStream file = storage.OpenFile(strFilePath, System.IO.FileMode.Open))
                        {
           ...
           for(int i =0; i<byteCount; i++)
           {
               ...
               {
                   AudioTrack audioTrack = null;
                   audioTrack = new AudioTrack(new Uri(filelist[i], UriKind.Relative),
                    "SriSathyaSaiBaba_App",
                    "PhoneApp",
                    "",
                    null);
