    ...
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        static AudioPlayer()
        {
          /*  # region Test data
            ...
            string[] audiofiles = new string[] {"cat.wma", "cow.wma","dog.wma", "duck.wma","elephant.wma","hen.wma", "horse.wma",
                                    "lion.wma","peacock.wma","tiger.wma","crow.wma"};
            for (int i = 0; i <= 10; i++)
            {
                audioTrack = new AudioTrack(new Uri(audiofiles[i], UriKind.Relative),
                                    "Animal_Sounds",
                                    "PhoneApp",
                                    audiofiles[i],
                                    null);
