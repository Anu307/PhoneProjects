...
namespace NativeAmericanFolkTales
{
    public partial class DetailsPage : PhoneApplicationPage
    {
        ...
        private void Email_Click(object sender, EventArgs e)
        {
            ...
            emailcomposetask.Subject = "NativeAmericanFolkTales story " + storyname.Replace("files\\", "");
        ...
        private void Feedback_Click(object sender, EventArgs e)
        {
            ...
            emailcomposetask.Subject = " Feedback for NativeAmericanFolkTales v1.00";
            emailcomposetask.To = "svam@outlook.com";
            emailcomposetask.Show();
        }
