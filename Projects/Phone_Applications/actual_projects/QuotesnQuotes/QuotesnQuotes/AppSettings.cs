...
namespace QuotesnQuotes
{
    public class AppSettings
    {
        ...
        const string ColorSettingDefault = "#FF4F9B47";
        const int LastQuoteSettingDefault = 0;
        const string FavoriteSettingDefault = "";
        const string FavoriteSettingName = "FavoriteSetting";
        const string LastQuoteSettingName = "LastQuoteSetting";
        const string ColorSettingName = "ColorSetting";
      ...
      /*  const string CheckBoxSettingKeyName = "CheckBoxSetting";
        ...
        public string FavoriteSetting
        {
            get
            {
                return GetValueOrDefault<string>(FavoriteSettingName, FavoriteSettingDefault);
            }
            set
            {
                if (AddOrUpdateValue(FavoriteSettingName, value))
                {
                    Save();
                }
            }
        ...
        public int LastQuoteSetting
        {
            get
            {
                return GetValueOrDefault<int>(LastQuoteSettingName, LastQuoteSettingDefault);
            }
            set
            {
                if (AddOrUpdateValue(LastQuoteSettingName, value))
                {
                    Save();
                }
            }
