...
namespace QuickDialPro
{
    public class AppSettings
    {
        ...
        const string Nickname0Setting = "Nickname0Setting";
        const string Nickname1Setting = "Nickname1Setting";
        const string Nickname2Setting = "Nickname2Setting";
        const string Nickname3Setting = "Nickname3Setting";
        const string Nickname4Setting = "Nickname4Setting";
        const string Nickname5Setting = "Nickname5Setting";
        const string Nickname6Setting = "Nickname6Setting";
        const string Nickname7Setting = "Nickname7Setting";
        const string Nickname8Setting = "Nickname8Setting";
        const string Nickname9Setting = "Nickname9Setting";

        const string Number0Setting = "Number0Setting";
        const string Number1Setting = "Number1Setting";
        const string Number2Setting = "Number2Setting";
        const string Number3Setting = "Number3Setting";
        const string Number4Setting = "Number4Setting";
        const string Number5Setting = "Number5Setting";
        const string Number6Setting = "Number6Setting";
        const string Number7Setting = "Number7Setting";
        const string Number8Setting = "Number8Setting";
        const string Number9Setting = "Number9Setting";
